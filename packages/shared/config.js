...
export const TOOL_CONFIG = {
  ...
  toolSpec: [
    ...
    "- run_terminal_command(command, background?): Run a shell command. Use background:true for long-running servers.",
    ...
    "- git_log(limit?): Show git commit history.",
    "- git_checkout(branch): Switch to a different branch.",
    "- git_branch(name?, delete?): List or create/delete branches.",
    "- delegate_task(role, task): Delegate a sub-task to a specialized agent role (planner, executor, reviewer, summarizer).",
    "Rules:",
